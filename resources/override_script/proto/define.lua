...
m.TokenModifiers = {
    ["declaration"]    = bit.lshift(1, 0),
    ["definition"]     = bit.lshift(1, 1),
    ["readonly"]       = bit.lshift(1, 2),
    ["static"]         = bit.lshift(1, 3),
    ["deprecated"]     = bit.lshift(1, 4),
    ["abstract"]       = bit.lshift(1, 5),
    ["async"]          = bit.lshift(1, 6),
    ["modification"]   = bit.lshift(1, 7),
    ["documentation"]  = bit.lshift(1, 8),
    ["defaultLibrary"] = bit.lshift(1, 9),
    ["global"]         = bit.lshift(1, 10),
}
